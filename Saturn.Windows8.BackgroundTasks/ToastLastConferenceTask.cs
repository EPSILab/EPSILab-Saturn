...
{
    /// <summary>
    /// Background task which display a toast notification if a new conference is available
    /// </summary>
    public sealed class ToastLastConferenceTask : IBackgroundTask
    {
        /// <summary>
        ...
        public async void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            try
            {
                ToastManager manager = new ConferenceToastManager();
