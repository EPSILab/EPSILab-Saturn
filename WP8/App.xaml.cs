...
namespace SolarSystem.Saturn.WP8
{
    public partial class App
    {
        ...
        public App()
        {
            ...
            // Abonnement aux changements intervenant sur la disponibilité de la connexion internet
            DeviceNetworkInformation.NetworkAvailabilityChanged += DeviceNetworkInformationOnNetworkAvailabilityChanged;

            // Vérifier une première fois si la connexion internet est disponible
        ...
        /// <summary>
        ///     Détermine si la connexion Internet est disponible
        /// </summary>
        ...
        /// <summary>
        ///     Rafraîchit la propriété indiquant si la connexion internet est disponible
        /// </summary>
        private void CheckIsNetworkAvailable()
        {
            IsInternetAvailable = DeviceNetworkInformation.IsNetworkAvailable &&
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            MessageBox.Show(AppResources.MSG_ERROR);
        }
        ...
        private void InitializeLanguage()
        {
            try
            {
                ...
                // the resource file.
                RootFrame.Language = XmlLanguage.GetLanguage("fr");
