...
namespace SolarSystem.Saturn.ViewModel
{
    class MainViewModel : MyViewModelBase, IMainViewModel
    {
        ...
        private async Task LoadBureauAsync()
        {
            ...
            if (membres != null)
            {
                IList<VisualGenericItem> genericMembres = MembreToGenericItemMapper.Mapper(membres);
        ...
        private async Task LoadMoreItemsAsync(string category)
        {
            ...
            switch (i)
            {
                case 0:
                    ...
                    newElements = NewsToGenericItemMapper.Mapper(news);
                    break;
                case 2:
                ...
                case 3:
                    ...
                    newElements = ConferenceToGenericItemMapper.Mapper(conferences);
                    break;
                case 4:
